...
@CucumberOptions
        (
                features = "classpath:/features/Settings.feature", //the path of the feature files
                glue={"ScryAIGroundX.com.qa.stepdefinitions.Settings","ScryAIGroundX.com.qa.commons"}, //the path of the step definition files
                ...
                monochrome = true,
                tags = "not @Skip",//display the console output in a proper readable format
